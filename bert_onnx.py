...
# Fixed Shape
#torch.onnx.export(model, (dummy_input0, dummy_input1, dummy_input2), "bert_fixed.onnx", verbose=True, opset_version=args.opset)
...
print(dynamic_axes)
torch.onnx.export(model,(dummy_input0, dummy_input1, dummy_input2), "bert_dynamic_1.onnx", verbose=True, opset_version=args.opset,input_names=input_names, output_names=output_names,dynamic_axes=dynamic_axes)
